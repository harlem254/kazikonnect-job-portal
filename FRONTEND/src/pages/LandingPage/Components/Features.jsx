            ...
            <div className="space-y-8">
              {jobSeekerFeatures.map((feature, index) => {
                ...
                return (
                  <div 
                    key={index} 
                    className="group flex items-start space-x-4 p-6 rounded-2xl transition-colors hover:bg-blue-50"
                  >
            ...
            <div className="space-y-8">
              {employerFeatures.map((feature, index) => {
                ...
                return (
                  <div 
                    key={index} 
                    className="group flex items-start space-x-4 p-6 rounded-2xl transition-colors hover:bg-purple-50"
                  >
